...
export const MEMBERS_PARTS_ITEMS: readonly MembersPartItem[] = [
  {
    ...
    altTranslationKey: 'BVKZ.MEMBERS__COMPONENT.MEMBERS__CART_IMAGE_ALT_CONDUCTOR',
  ...
  },
  {
    ...
    altTranslationKey: 'BVKZ.MEMBERS__COMPONENT.MEMBERS__CART_IMAGE_ALT_FIRST_VIOLIN',
    members: [
  ...
  },
  {
    ...
    altTranslationKey: 'BVKZ.MEMBERS__COMPONENT.MEMBERS__CART_IMAGE_ALT_SECOND_VIOLIN',
    members: [
  ...
  },
  {
    ...
    altTranslationKey: 'BVKZ.MEMBERS__COMPONENT.MEMBERS__CART_IMAGE_ALT_VIOLA',
    members: [
      {
  ...
  },
  {
    ...
    altTranslationKey: 'BVKZ.MEMBERS__COMPONENT.MEMBERS__CART_IMAGE_ALT_CELLO',
    members: [
      {
  ...
  },
  {
    ...
    altTranslationKey: 'BVKZ.MEMBERS__COMPONENT.MEMBERS__CART_IMAGE_ALT_CONTRABASS',
    members: [
      {
