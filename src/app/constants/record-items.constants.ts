...
export const RECORD_ITEMS: readonly RecordItem[] = [
  {
    ...
    tracks: [
      ...
      {
        trackSource: 'vedró_short',
        audioTitle: 'Antonio Vivaldi - Vedró con mio diletto ária (részlet a Giustino című operából)',
        soloistName: 'Nagy Anna',
      },
      {
      ...
      },
      {
        ...
        audioTitle: 'Wolfgang Amadeus Mozart - Barbarina kavatinája (részlet a Figaro házassága című operából)',
        soloistName: 'Dömötör Emőke',
      },
      {
      ...
      },
      {
        ...
        audioTitle: 'Edvard Grieg - Solvejg dala (részlet a Peer Gynt című kísérőzenéből)',
        soloistName: 'Horváth Mária',
      },
      {
      ...
      },
      {
        ...
        audioTitle: 'Gabriel Fauré-Héja Benedek - Après un rêve (Álom után, op.7, No. 1)',
        soloistName: 'Horváth Cecília',
      },
      {
  ...
  },
  {
    ...
    tracks: [
      ...
      },
      {
        ...
        audioTitle: 'Sugár Rezső - Rondo',
        soloistName: 'Koós Eszter',
      },
      {
      ...
      },
      {
        ...
        audioTitle: 'Richard Strauss - Morgen',
        soloistName: 'Kertész Szilvia, Nánay Mihály',
      },
      {
      ...
      },
      {
        ...
        audioTitle: 'Dmitrij Dmitrijevics Sosztakovics - II. zongoraverseny, Op. 102 - Andante',
        soloistName: 'Koós Eszter',
      },
      {
      ...
      },
      {
        ...
        audioTitle: 'Antonio Vivaldi - C-dúr furulyaverseny, RV 443',
        soloistName: 'Trautsch Ildikó',
      },
      {
